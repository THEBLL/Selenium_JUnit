...
public class C03_FileUploadTesti extends TestBase {
    ...
    public void fileUpTesti(){
        ...
        /*
        choose file sectigimiz de pc deki dosyayi aciyor bundan dolayi
        webelement olusturup sendkeys yapiyoruz
         */

        WebElement uploadButtonElemnti = driver.findElement(By.id("file-upload"));
        String dinamikDosyaYolu = System.getProperty("user.dir") + "/src/test/java/day11_fileTestleri_Waits/text.txt";

        uploadButtonElemnti.sendKeys(dinamikDosyaYolu);
